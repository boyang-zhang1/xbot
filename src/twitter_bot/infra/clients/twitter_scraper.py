"""Tweety-based scraper client implementation."""
...
class TweetyScraperClient(ScraperClient):
    """Scraper client that leverages the tweety library to collect tweets."""
    ...
    def _session_path(self, username: str) -> Path:
        return self._session_dir / f"twitter_session_{username}.json"
